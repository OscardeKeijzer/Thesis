...
_n_seeds = 10
_k_list = ['10y']#['6m', '1y', '2y', '3y', '5y', '10y']
_moneynesses = [.5, 2.]
...
for _k in _k_list:
    for seed in range(0,_n_seeds):
        ...
        exp_dir_name = f'Bump-and-Revalue 5Yx5Y Time-Zero {_k} dVdR Moneyness'
        ...
        tenor_structure = np.arange(5., 10.+1)
        time_t = 0.
        ...
        for _moneyness in _moneynesses:
            # Update data and figure directories according to moneyness
            one_factor_HW_model.experiment_dir = one_factor_HW_exp_dir + f' {_moneyness*100}%'
